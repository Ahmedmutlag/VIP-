...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    private static final String[] MESSAGES = {
        "حمّل فيديوهاتك المفضلة الآن بضغطة واحدة! ⬇️",
        "شاهدت فيديو حلو اليوم؟ نزّله واحتفظ به! 🎵",
        "تيك توك، انستقرام، فيسبوك... كلها في نزلها بلس 📲",
        "بدون علامة مائية، بدون تسجيل، مجاناً تماماً ✨",
        "فيديوهاتك المفضلة تستحق أن تُحفظ! افتح نزلها بلس 🚀",
        "هل رأيت فيديو مميز اليوم؟ حمّله الآن بسهولة 💾",
        "نزّل أي فيديو في ثوانٍ معدودة مع نزلها بلس ⚡",
    };
